	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag (ASEVaryingsDefault i  ) : SV_Target
			{
				...
				float4 tex2DNode16 = tex2D( _MainTex, pixelateduv99 );
				float4 tex3DNode21 = tex3D( _Primary, tex2DNode16.rgb );
				float simplePerlin2D55 = snoise( pixelateduv99*400.0 );
...
Node;AmplifyShaderEditor.TFHCPixelate;99;-983.9498,-52.06746;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;16;-691.7579,-108.0669;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
